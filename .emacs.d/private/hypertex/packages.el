;;; packages.el --- hypertex layer packages file for Spacemacs.
;;
...
;; added to `hypertex-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `hypertex/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `hypertex/pre-init-PACKAGE' and/or
;;   `hypertex/post-init-PACKAGE' to customize the package as it is loaded.
